...
TO_BE = {
            ...
            "sections": [
                {
                    ...
                    "examples_work": [
                        ["I am a warehouse worker.", "Jestem pracownikiem magazynu. (kim)"],
    ...
    "practice": [
        ...
        {"type": "listen_choice", "en": "We aren't ready yet.", "text": "Posłuchaj. Co znaczy to zdanie?",
         "options": ["Nie jesteśmy jeszcze gotowi.", "Jesteśmy już gotowi.", "Nie byliśmy gotowi."], "answer": 0,
         "why": "„aren't” = are not (przeczenie, teraźniejszość), „yet” = jeszcze.",
         "why_not": {"Jesteśmy już gotowi.": "Słyszysz przeczenie AREN'T — zdanie jest przeczące.",
                     "Nie byliśmy gotowi.": "To byłoby WEREN'T (przeszłość). Tu jest AREN'T — teraz."}},
        {"type": "listen_choice", "en": "Is your sister a nurse?", "text": "Posłuchaj. Które zdanie usłyszałeś?",
         "options": ["Is your sister a nurse?", "Is your sister at work?", "Was your sister a nurse?"], "answer": 0,
         "why": "Pytanie w teraźniejszości (IS) o zawód (a nurse — pielęgniarka).",
         "why_not": {"Is your sister at work?": "Na końcu słychać „a nurse”, nie „at work”.",
                     "Was your sister a nurse?": "Na początku jest IS, nie WAS."}},
        {"type": "order", "en": "My parents are not at home.", "pl": "Moich rodziców nie ma w domu.",
         "why": "Podmiot (my parents) → forma TO BE (are) → not → reszta."},
        {"type": "order", "en": "Are you tired today?", "pl": "Jesteś dziś zmęczony?",
         "why": "Pytanie: forma TO BE (are) przed osobą (you)."},
        {"type": "fix", "wrong": "She am my best friend.", "bad": 1, "right": "is", "fixed": "She is my best friend.",
         "pl": "Ona jest moją najlepszą przyjaciółką.",
         "why": "AM jest tylko z I. She → IS."},
        {"type": "fix", "wrong": "I have 25 years old.", "bad": 1, "right": "am", "fixed": "I am 25 years old.",
         "pl": "Mam 25 lat.",
         "why": "Wiek po angielsku wyraża się przez TO BE: I am 25 (years old), nie „have”."},
        {"type": "cloze", "text": "Uzupełnij tekst — część luk wybierasz z listy, część wpisujesz:",
         "body": "Hi! My name [[is|am|are]] Anna. I [[=am]] from Poland. My brother and I [[are|is|am]] students. "
                 "He [[=is]] 20 and I'm 22. We [[=are]] not rich, but we [[are|is|were]] happy. Yesterday we [[were|are|was]] at a concert. It [[=was]] great!",
         "pl": "Cześć! Mam na imię Anna. Jestem z Polski. Mój brat i ja jesteśmy studentami. On ma 20 lat, a ja 22. "
               "Nie jesteśmy bogaci, ale jesteśmy szczęśliwi. Wczoraj byliśmy na koncercie. Było świetnie!",
         "why": "I → am · he / it → is · we / they / brother and I → are; wczoraj → was / were."},
    ],
    "test": [
        ...
        {"type": "listen_choice", "en": "He isn't at work today.", "text": "Posłuchaj. Co znaczy to zdanie?",
         "options": ["Nie ma go dziś w pracy.", "Jest dziś w pracy.", "Nie było go wczoraj w pracy."], "answer": 0,
         "why": "ISN'T = is not — przeczenie w teraźniejszości.",
         "why_not": {"Jest dziś w pracy.": "Słychać ISN'T — przeczenie.",
                     "Nie było go wczoraj w pracy.": "To byłoby WASN'T … yesterday. Tu jest ISN'T … today."}},
        {"type": "fix", "wrong": "They is very tired.", "bad": 1, "right": "are", "fixed": "They are very tired.",
         "pl": "Oni są bardzo zmęczeni.", "why": "They → ARE. IS tylko dla he / she / it."},
        {"type": "cloze", "text": "Uzupełnij:",
         "body": "Tom [[=is]] my colleague. We [[are|is|am]] in the same team. He [[=is]] not here today — he [[was|is|were]] ill yesterday. [[Are|Is|Am]] you his friend?",
         "pl": "Tom jest moim kolegą. Jesteśmy w tym samym zespole. Nie ma go dziś — wczoraj był chory. Jesteś jego przyjacielem?",
         "why": "Tom / he → is · we → are · wczoraj → was · pytanie do you → Are you…?"},
    ],
}
